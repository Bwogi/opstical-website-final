              ...
              <main className="md:flex-auto md:pl-10 order-1" data-aos="fade-up">
                ...
                <div className={page !== 1 ? 'hidden' : undefined}>
                  <div className="mb-8">
                    ...
                    <p className="text-gray-400">Last updated - <span className="text-red-600">June 30, 2020</span></p>
                  </div>
                  <ul className="-my-4">
                    <li className="py-4">
                ...
                <nav>
                  <ul>
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-red-600 transition duration-150 ease-in-out ${page === 1 && 'text-red-600'}`}
                        href="#0"
                        onClick={(e) => { e.preventDefault(); setPage(1); }}
                      >
                        <span>Frequently Asked Questions</span>
                        <svg className="w-3 h-3 fill-current shrink-0 ml-2 opacity-0 group-hover:opacity-100 group-hover:text-red-600 group-hover:translate-x-1 transition duration-150 ease-in-out transform" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-red-600 transition duration-150 ease-in-out ${page === 2 && 'text-red-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-red-600 transition duration-150 ease-in-out ${page === 3 && 'text-red-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-red-600 transition duration-150 ease-in-out ${page === 4 && 'text-red-600'}`}
                        href="#0"
                    ...
                    <li className="py-2 border-b border-gray-800">
                      <a
                        className={`flex items-center px-3 group text-gray-400 hover:text-red-600 transition duration-150 ease-in-out ${page === 5 && 'text-red-600'}`}
                        href="#0"
