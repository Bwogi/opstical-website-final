                ...
                {items.map((item, index) => (
                  ...
                  >
                    <div className="relative inline-flex flex-col justify-center mb-4">
                      ...
                      <svg className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-red-800" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-gray-700 font-medium mt-3">
                      <cite className="text-gray-200 not-italic">{item.name}</cite> / <span className="text-red-800">{item.role}</span>
                    </div>
                  </Transition>
                ))}
