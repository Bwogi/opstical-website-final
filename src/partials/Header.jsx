      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <Link to="/" className="block" aria-label="Opstical LLC.">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
              ...
              <li>
                <Link to="/blog" className="text-gray-300 hover:text-gray-200 px-4 py-2 flex items-center transition duration-150 ease-in-out">Our Blog</Link>
              </li>
              <li>
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link to="/signin" className="font-medium text-red-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Sign in</Link>
              </li>
              <li>
                <Link to="/signup" className="btn-sm text-white rounded-md bg-red-800 hover:bg-red-700 ml-3">Sign up</Link>
              </li>
            </ul>
          ...
          <div className="md:hidden">
            ...
            <nav id="mobile-nav" ref={mobileNav} className="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" style={mobileNavOpen ? { maxHeight: mobileNav.current.scrollHeight, opacity: 1 } : { maxHeight: 0, opacity: .8 } }>
              ...
              <li>
                ...
                <li>
                  <Link to="/features" className="flex text-gray-300 hover:text-gray-200 py-2">Our Workflow</Link>
                </li>
                
                <li>
                  <Link to="/blog" className="flex text-gray-300 hover:text-gray-200 py-2"> Our Blog</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/signup" className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2  text-white bg-red-800 hover:bg-red-700 transition duration-150 ease-in-out">Sign up</Link>
                </li>
              </ul>
            </nav>
